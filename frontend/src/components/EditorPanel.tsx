            ...
            <div className='space-y-4 text-black'>
                ...
                <div>
                    ...
                    <input
                        ...
                        className='w-full text-sm p-2 border rounded-md focus:ring-2 focus:ring-indigo-500 border-gray-400 outline-none'
                    />
                </div>
                <div className='grid grid-cols-2 gap-3'>
                    <div>
                        ...
                        <input
                            ...
                            className='w-full text-sm p-2 border rounded-md focus:ring-2 border-gray-400 focus:ring-indigo-500 outline-none'
                        />
                    </div>
                    <div>
                ...
                <div className='grid grid-cols-2 gap-3'>
                    <div>
                        ...
                        <div className='flex items-center gap-2 border border-gray-400 rounded-md p-1'>
                            <input
                                type='text'
                                value={values.styles.backgroundColor === "rgb(0,0,0,0)" ? "#ffffff" : values.styles.backgroundColor}
