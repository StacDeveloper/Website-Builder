import { CircleIcon, ScanLine, SquareIcon, TriangleIcon } from 'lucide-react'
import  { useEffect, useState } from 'react'

const steps = [
    { icon: ScanLine, label: "Analysing your request..." },
...
const LoaderSteps = () => {
    ...
    return (
        <div className='w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white'>
            ...
            {/* Step label - fade using transaction only (no invisible start) */}
